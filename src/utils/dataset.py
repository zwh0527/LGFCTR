...
def read_megadepth_gray(path, resize=None, df=None, padding=False, augment_fn=None):
    ...
    #image = (torch.from_numpy(image).float()[None] / 255 - 0.4893) / 0.2680 # use random 20 scenes of MegaDepth to calulate
...
def read_megadepth_rgb(path, resize=None, df=None, padding=False, augment_fn=None):
    ...
    if padding:  # padding
        ...
        mask = None
    print()
    transform = Compose([ToTensor(), Normalize(mean=[0.4858, 0.4916, 0.4865], std=[0.2656, 0.2717, 0.2978])])
